...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed z-40 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp shadow-lg transition-all duration-300 hover:scale-110 right-4 bottom-20 md:right-6 md:bottom-6 ${
        visible
